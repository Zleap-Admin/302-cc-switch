...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new("/Applications/302 CC Switch.app/Contents/MacOS/302 CC Switch");
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/302 CC Switch.app/Contents/MacOS/302 CC Switch");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
