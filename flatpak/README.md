...
```bash
flatpak-builder --force-clean --user --disable-cache --repo flatpak-repo flatpak-build flatpak/com.ai302.ccswitch.yml
flatpak build-bundle --runtime-repo=https://flathub.org/repo/flathub.flatpakrepo flatpak-repo CC-Switch-Linux.flatpak com.ai302.ccswitch
```
...
flatpak run com.ai302.ccswitch
```
...
If you plan to publish on Flathub or want stricter permission control, adjust the `finish-args` in `flatpak/com.ai302.ccswitch.yml` accordingly.
