...
- **Automatic backup**: Before deletion, the skill is backed up to `~/.302-cc-switch/skill-backups/`
- Removes the skill from all app directories (Claude, Codex, Gemini, OpenCode, Hermes)
- Removes the skill from the SSOT directory (`~/.302-cc-switch/skills/`)
...
| ------------------------ | --------------------------------------------------------------------- |
| **CC Switch built-in**   | Default location `~/.302-cc-switch/skills/`, managed by CC Switch         |
