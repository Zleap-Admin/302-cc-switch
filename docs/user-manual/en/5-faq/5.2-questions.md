...
**Solutions**:
1. Check if the `~/.302-cc-switch/` directory exists
2. Restore from backup: `~/.302-cc-switch/backups/`
...
2. Restart the app
3. Delete `~/.302-cc-switch/settings.json` to reset settings
...
- macOS/Linux: `~/.302-cc-switch/logs/`
